...
This was the first method of sequencing, but there are more. Shotgun sequencing involves blowing up the DNA into millions of fragments and sequencing each part, then assembling them all into one. This was invented by Craig Venter around 1998, first to sequence *Haemophilus influenzae* and eventually the human genome - he founded Celera to do this. It was acquired by Quest Diagnostics in 2011!
